...
router.get("/:id/edit", async (req, res) => {
  try {
    ...
    console.log("Erro caiu no catch");
    res.status(422).render("pages/error", { error: "Erro ao editar a lista de tarefa" });
  }
});
...
router.get("/:id", async (req, res) => {
  try {
    ...
    res.status(500).render("pages/error", { error: "Erro ao exibir a lista de tarefa" });
  }
});
